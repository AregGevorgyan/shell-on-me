...
- Custom domain(s): e.g. `startupshell.org`
...
3. In Render dashboard → Environment, add all secrets listed as comments in `render.yaml`:
   ...
   - All 31 backend secrets (API_SECRET, MAILGUN_KEY, SUPABASE_KEY, etc.)
...
3. Create a task definition:
   ...
   - Environment variables: set `IS_PROD=true`, `NEXT_PUBLIC_FIREBASE_ENV=PROD`, `FIREBASE_PROJECT_ID`, `FIREBASE_SERVICE_ACCOUNT_KEY`, and all 31 backend secrets
