...
export const track = async (
  ...
  _amplitudeProperties?: Record<string, unknown>
) => {
  // External analytics providers are disabled in StartupShell deployments.
  return await tryOrLogError(Promise.resolve())
}
